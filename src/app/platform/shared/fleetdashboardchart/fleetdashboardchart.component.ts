...
@Component({
  selector: 'app-fleetdashboardchart',
  templateUrl: './fleetdashboardchart.component.html',
  styleUrls: ['./fleetdashboardchart.component.css']
})
export class FleetdashboardchartComponent implements OnInit {
