...
SignalR.ɵfac = function SignalR_Factory(t) { return new (t || SignalR)(ɵngcc0.ɵɵinject(SignalRConfiguration), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(SIGNALR_JCONNECTION_TOKEN)); };
SignalR.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SignalR, factory: function (t) { return SignalR.ɵfac(t); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SignalR, [{
        type: Injectable
    }], function () { return [{ type: SignalRConfiguration }, { type: ɵngcc0.NgZone }, { type: Function, decorators: [{
                type: Inject,
